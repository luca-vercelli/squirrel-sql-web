...
public class SessionsManager {
    ...
    public SessionProperties setProperties(ISession session, SessionProperties newProps) {
        ...
        logger.info("DEBUG HERE WE ARE SAVING getContentsNbrRowsToShow=" + newProps.getContentsNbrRowsToShow() + "; "
                + prop.getContentsNbrRowsToShow() + "; " + prop.getClass());
        ...
        logger.info("DEBUG HERE WE ARE SAVING getSQLNbrRowsToShow=" + newProps.getSQLNbrRowsToShow() + "; "
                + prop.getSQLNbrRowsToShow() + "; " + prop.getClass());
