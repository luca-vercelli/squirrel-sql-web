  ...
  implements IApplication
{
  ...
  private boolean closeAllSessions()
  {
    ...
    try
    {
      if (!this._sessionManager.closeAllSessions()) {
        s_log.info(s_stringMgr.getString("Application.shutdownCancelled", new Object[] {Calendar.getInstance()
          .getTime() }));
      } else {
        result = true;
      }
  ...
  private void executeStartupTasks(SquirrelSplashScreen splash, ApplicationArguments args)
  {
    ...
    if (loadPlugins)
    {
      ...
      for (it = this._pluginManager.getPluginLoadInfoIterator(); it.hasNext();)
      {
        ...
        Object[] params = { pli.getInternalName(), Long.valueOf(created), Long.valueOf(load), Long.valueOf(init), Long.valueOf(created + load + init) };
  ...
  {
    this._aliasesAndDriversManager = new AliasesAndDriversManager(this._driverMgr, this._appFiles.getDatabaseDriversFile(), this._appFiles.getDatabaseAliasesFile(), this._resources.getDefaultDriversUrl());
  }
  ...
  protected void loadSQLHistory()
  {
    ...
    catch (FileNotFoundException localFileNotFoundException) {}catch (Exception ex)
    {
  ...
  private void saveUserSpecificWikiConfigurations()
  {
    try
    {
      WikiTableConfigurationStorage data = new WikiTableConfigurationStorage(this.wikiTableConfigFactory.getUserSpecificConfigurations());
  ...
  protected void loadEditWhereColsInfo()
  {
    ...
    catch (Exception ex)
    {
      ex = 
        ...
        ex;s_log.error(s_stringMgr.getString("Application.error.loadcolsinfo"), ex);
    }
    finally {}
  }
  ...
  protected void loadDTProperties()
  {
    ...
    catch (Exception ex)
    {
      ex = 
        ...
        ex;s_log.error(s_stringMgr.getString("Application.error.loaddatatypeprops"), ex);
    }
    finally {}
  }
